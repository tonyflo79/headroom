...
routing, recovery, token detail, diagnostics after the diagnostics stack is
rebased, and the signed-update surface.
...
| --- | --- | --- |
| 2026-07-17 | automated jsdom + axe-core 4.12.1, Node 22 | dashboard, onboarding, recovery, settings, routing, popover, account, token, and update scans pass; contrast/keyboard/semantics/locale/reduced-motion pass |
...
Diagnostics must be added to the automated surface matrix after the redacted
diagnostics PR is merged into this stack. Do not close issue #17 until both
human rows and that combined scan are complete.
